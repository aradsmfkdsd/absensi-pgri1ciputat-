...
<div class="admin-page-header">
   <div>
      <h1 class="page-title">Import Data Guru</h1>
      <div class="breadcrumb">
         <a href="<?= base_url('admin/dashboard'); ?>">Dashboard</a>
         <span class="breadcrumb-sep">›</span>
         <a href="<?= base_url('admin/guru'); ?>">Data Guru</a>
         <span class="breadcrumb-sep">›</span>
...
<div class="card">
   <div class="flex flex-col lg:flex-row divide-y lg:divide-y-0 lg:divide-x divide-gray-100">
      ...
      <div class="flex-1 p-6 sm:p-8">
         <div class="mb-6">
            <h2 style="font-size:16px;font-weight:600;color:var(--text-primary); margin:0 0 4px 0;">Bulk Upload CSV Guru</h2>
            <p style="font-size:13px;color:var(--text-muted); margin:0;">Import data guru dari CSV</p>
         </div>
         ...
         <div class="form-group mb-0" style="padding-bottom: 0 !important;">
            ...
            <div id="csv_upload_spinner" class="csv-upload-spinner" style="display:none; text-align: center; margin-top: 24px;">
               <strong class="text-csv-importing" style="font-size: 14px; color: var(--primary);">Mengimpor Data Guru...</strong>
      ...
      <div class="w-full lg:w-[320px] p-6 sm:p-8 bg-gray-50/50">
         ...
         <form action="<?= base_url('admin/guru/downloadCSVFilePost'); ?>" method="post">
            ...
            <div style="display: flex; flex-direction: column; gap: 12px;">
               <button class="btn btn-primary w-full justify-center" name="submit" value="csv_guru_template" style="background: var(--primary); color: #fff;">
        ...
        if (index <= numberOfItems) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (objSub.result == 1) {
                        $("#csv_uploaded_files").prepend('<li class="list-group-item list-group-item-success"><i class="material-icons" style="font-size:14px;vertical-align:middle;margin-right:4px;">check_circle</i> ' + objSub.index + '. ' + objSub.guru.nuptk + ' - ' + objSub.guru.nama_guru + '</li>');
                    } else {
