...
<div class="flex flex-col md:flex-row gap-6">
   ...
   <div class="flex-1">
      <div class="card">
         <div class="mb-4">
            <h2 style="font-size:16px;font-weight:600;color:var(--text-primary);">Bulk Upload CSV Guru</h2>
            <p style="font-size:13px;color:var(--text-muted);">Import data guru dari CSV</p>
         </div>
      ...
      <div class="card">
         ...
         <form action="<?= base_url('admin/guru/downloadCSVFilePost'); ?>" method="post">
            ...
            <div style="display: flex; flex-direction: column; gap: 12px;">
               <button class="btn btn-primary w-full justify-center" name="submit" value="csv_guru_template">
