                  ...
                  <td>
                     <div class="flex items-center justify-center gap-2">
                        ...
                        <form action="<?= base_url('admin/guru/delete/' . $value['id_guru']); ?>" method="post" class="m-0">
                           ...
                           <button title="Hapus" onclick="return confirm('Konfirmasi untuk menghapus data guru ini?');" type="submit" 
                              class="btn btn-sm btn-outline hover:bg-red-50 hover:text-red-600 hover:border-red-100">
