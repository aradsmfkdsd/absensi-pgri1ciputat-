    ...
    <div class="max-w-2xl mx-auto">
      ...
      <div class="card mb-0">
        <div class="card-header border-b border-gray-100 flex items-center justify-between">
           <div>
              <h4 class="text-lg font-bold text-gray-900">Tambah Kelas Baru</h4>
        ...
        <div class="card-body">
          <form action="<?= base_url('admin/kelas/tambahKelasPost'); ?>" method="post" class="space-y-6">
            <?= csrf_field() ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input type="text" id="tingkat" name="tingkat"
                   ...
                   placeholder="Contoh: VII, VIII, IX" value="<?= old('tingkat') ?>" required>
              ...
              <div>
                ...
                <input type="text" id="index_kelas" name="index_kelas"
                   ...
                   placeholder="Contoh: A, B, C, 1, 2" value="<?= old('index_kelas') ?>" required>
            ...
            <div class="pt-6 border-t border-gray-100 flex justify-end gap-3">
               ...
               <button type="submit" class="btn btn-primary">
                  <i class="material-icons">save</i> Simpan Kelas
               </button>
            </div>
          </form>
        </div>
