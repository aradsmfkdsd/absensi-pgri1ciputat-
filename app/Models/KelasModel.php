...
class KelasModel extends BaseModel
{
   ...
   public function inputValues()
   {
      return [
         ...
         'id_jurusan' => empty(inputPost('id_jurusan')) ? 1 : inputPost('id_jurusan'),
         'index_kelas' => inputPost('index_kelas'),
         'id_wali_kelas' => empty(inputPost('id_wali_kelas')) ? null : inputPost('id_wali_kelas'),
      ];
   }
   ...
   {
      return $this->builder->select('tb_kelas.*, tb_jurusan.jurusan, tb_guru.nama_guru as nama_wali_kelas, CONCAT(tb_kelas.tingkat, " ", tb_kelas.index_kelas) as kelas')
   ...
   {
      return $this->select('tb_kelas.*, tb_jurusan.jurusan, CONCAT(tb_kelas.tingkat, " ", tb_kelas.index_kelas) as kelas')
         ->join('tb_jurusan', 'tb_kelas.id_jurusan = tb_jurusan.id', 'left')
         ->findAll();
   }
